 ...
 * Use the [inicialFuncionarioFragment.newInstance] factory method to
...
class inicialFuncionarioFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment inicialFuncionarioFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            inicialFuncionarioFragment().apply {
