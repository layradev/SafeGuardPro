 ...
 * Use the [ListaFuncionariosFragment.newInstance] factory method to
...
class ListaFuncionariosFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ListaFuncionariosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ListaFuncionariosFragment().apply {
